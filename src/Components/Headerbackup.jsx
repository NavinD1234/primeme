...
function Header() {
  ...
  useEffect(() => {
    function handleScroll() {
      if (headerDivRef.current) {
        ...
        const headerDivHeight = headerDivRef.current.getBoundingClientRect().height;
  ...
  return (
    ...
    <div
      ...
      ref={headerDivRef} // Assign the ref to the header-div-1 element
    >
                ...
                <ol className="header-nav-profile-ol">
                  <li className="header-nav-profile-li">
                    <label className="header-nav-profile-li-label">
                      ...
                      <div>
      {/* Display the user's name if logged in, otherwise display "Login" */}
      <span className="header-nav-profile-li-label-div-span-1">
        {userName ? userName : 'Login'}
      </span>
      {/* Button to log out and remove the token */}
      {/* Add the rest of your Index page content */}
      {/* ... */}
    </div>
</span>
